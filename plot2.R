...
## Make the second plot of interest (line graph of Global Active Power vs. Time)

myUseData <- readAndCleanData()

png(filename="plot2.png")

plot(myUseData$useTime,myUseData$Global_active_power,ylab="Global Active Power (kilowatts)",
     xlab="",type="l")
