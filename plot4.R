...
## Make the fourth plot of interest (2x2 bycol) - plot 2, plot 3, Voltage vs. Time, Reactive vs. Time
...
plot(myUseData$useTime,myUseData$Global_active_power,ylab="Global Active Power",
     xlab="",type="l")

plot(myUseData$useTime,myUseData$Sub_metering_1,ylab="Energy sub metering",xlab="",type="l")
lines(myUseData$useTime,myUseData$Sub_metering_2,col="red")
lines(myUseData$useTime,myUseData$Sub_metering_3,col="blue")
legend("topright",col=c("black","red","blue"),lty=1,
       legend=c("Sub_metering_1","Sub_metering_2","Sub_metering_3"))

plot(myUseData$useTime,myUseData$Voltage,ylab="Voltage",xlab="datetime",type="l")

plot(myUseData$useTime,myUseData$Global_reactive_power,ylab="Global_reactive_power",
